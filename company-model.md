...
| Field        | Type     | Description |
|--------------|----------|-------------|
| brand        | string   | Commercial brand name (e.g. "Yonder") |
| group        | string   | Parent company group (e.g. "YONDER SRL") |
...
- **scraperFile**: Full URL to GitHub raw workflow YML (e.g. `https://raw.githubusercontent.com/emtreila/yonder-scraper/master/.github/workflows/scrape.yml`)
